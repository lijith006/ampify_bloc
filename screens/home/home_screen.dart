...
//                     onDeleted: () =>
//                         setState(() => filter.categories!.remove(category)),
//                   );
//                 }).toList(),
...
//                     onDeleted: () =>
//                         setState(() => filter.brands!.remove(brand)),
//                   );
//                 }).toList(),
...
//                 return FilterChip(
//                   label: Text(doc['name']),
//                   selected: filter.categories?.contains(doc.id) ?? false,
//                   onSelected: (selected) {
//                     setState(() {
//                       filter.categories ??= [];

//                       if (selected) {
//                         filter.categories!.add(doc.id);
//                       } else {
//                         filter.categories!.remove(doc.id);
//                       }
//                     });
//                   },
//                 );
...
//                 return FilterChip(
//                   label: Text(doc['name']),
//                   selected: filter.brands?.contains(doc.id) ?? false,
//                   onSelected: (selected) {
//                     setState(() {
//                       filter.brands ??= [];
//                       if (selected) {
//                         filter.brands!.add(doc.id);
//                       } else {
//                         filter.brands!.remove(doc.id);
//                       }
//                     });
//                   },
//                 );
