...
//                   onDeleted: () => onClearFilter('search'),
//                 ),
//               if (filter.categories != null)
//                 Chip(
//                   label: Text('Category: ${filter.categories}'),
//                   onDeleted: () => onClearFilter('category'),
//                 ),
//               if (filter.brands != null)
//                 Chip(
//                   label: Text('Brand: ${filter.brands}'),
//                   onDeleted: () => onClearFilter('brand'),
//                 ),
